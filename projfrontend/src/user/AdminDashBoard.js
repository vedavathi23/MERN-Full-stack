...
const AdminDashBoard = () => {
    ...
    // Destructuring the user details coming from backend

    const { user: { name, email, role } } = isAuthenticated();

    // Admin leftside navigation
    ...
    return (
        <Base title="Welcome to admin are" description="Manage all of your products here" className="container bg-success p-4">
            <div className="row">
